"""
Django settings for ruralmart project.
...
CORS_ALLOW_CREDENTIALS = os.getenv("CORS_ALLOW_CREDENTIALS", default="False") == "True"
...
WSGI_APPLICATION = "ruralmart.wsgi.application"
